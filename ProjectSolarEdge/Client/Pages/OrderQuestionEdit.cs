    ...
    public partial class OrderQuestionEdit
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (QId == 0) //new Game is being created
            {
                ...
                //add some defaults
                QuestionsCRUD = new Question { CreationDate = DateTime.Now, UpdateDate = DateTime.Now, Type = (QuestionType)3, Difficulty = (QuestionDifficulty)1, Feedback = "", Creator = CreatorName, QuestionImagePath = newQuestionIMG };
