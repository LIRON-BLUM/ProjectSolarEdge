...
namespace ProjectSolarEdge.Shared.Services.Questions
{
    public static class QuestionsQueries
    {
		...
		public static string AddAnswer => @"INSERT INTO QuestionAnswers
													...
													CreationDate,
													UpdateDate,
													IsRight,isDeleted, QuestionOrder, AnswerImagePath)
											  VALUES (@QuestionID, @AnswerBody, @CreationDate, @UpdateDate, @IsRight,0, @QuestionOrder, @AnswerImagePath)";
        ...
        public static string DeleteSubjectByIDFromConnection => @"DELETE FROM SubjectsQuestionsConnection WHERE SubjectID = @SubjectID";
